...
<%@page import="com.dan.app.utilities.Fecha"%>
...
<html>
    ...
    <body>       
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <img src="img/DYS.png" alt="" style="width: 200px"/>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                   
     
                    <li class="nav-item active">
                        <a class="nav-link" href="../pagina principal/Productos.jsp"><i class="fas fa-home"></i> Inicio<span class="sr-only">(current)</span></a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link" href="../vistas/addProducto.jsp"><i class="fas fa-plus-circle"></i> Ofertas del Dia</a>
                    </li>                   
                    
                    <li class="nav-item">
                        <a class="nav-link" href="../vistas/compras.jsp"><i class="fas fa-cart-plus">(<label style="color: darkorange">${cont}</label>)</i> Carrito</a>
                    </li> 
                    
                    <li class="nav-item">
                        <a class="nav-link" href="../vistas/DetalleCompra.jsp">Productos</a>
                    </li> 
                            ...
                            <c:forEach var="c" items="${Carrito}"> 
                                <tr class="text-center tr">
                                    ...
                                    <td class="text-center">                                         
                                        <input type="hidden" id="item2" value="${car.getIdProducto()}">
