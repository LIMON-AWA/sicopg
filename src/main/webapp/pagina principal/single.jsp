<%-- 
    Document   : single
    Created on : 17/12/2022, 09:24:59 PM
    Author     : CrisPC
--%>
                ...
                <div class="container">
                                ...
                                <ul id="etalage">
                                    <li>
                                        <a href="optionallink.jsp">
                                            <img class="etalage_thumb_image" src="images/3.png" />
                                            <img class="etalage_source_image" src="images/3.png" />
                                        </a>
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/4.png" />
                                        <img class="etalage_source_image" src="images/4.png" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/5.png" />
                                        <img class="etalage_source_image" src="images/5.png" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/6.png" />
                                        <img class="etalage_source_image" src="images/6.png" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/7.png" />
                                        <img class="etalage_source_image" src="images/7.png" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/8.png" />
                                        <img class="etalage_source_image" src="images/8.png" />
                                    </li>
                                    <li>
                                        <img class="etalage_thumb_image" src="images/9.png" />
                                        <img class="etalage_source_image" src="images/9.png" />
                                    </li>
                                </ul>
                            </div>
                            <!-- end product_slider -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="shop_desc"><a href="single.jsp">
                                </a><h3><a href="single.jsp"></a><a href="#">Cerveza Corona</a></h3>
                                <p>Corona Extra es la cerveza de origen 100% mexicano más vendida en el mundo, solo producida en México, y dedicada a promover lo mejor de nuestra cultura en el mundo. De ligero aroma a malta y notas a ésteres en buen equilibrio con un sabor ligeramente dulce y con carácter a levadura. Cuerpo medio a completo.

Considerada una de las marcas más valiosas del planeta, Corona Extra se enfoca en dar una sensación de frescura y relajación a sus consumidores.

En Sam's podrás encontrar una gran variedad de vinos, licores y cervezas para tus fiestas, reuniones o negocio. Realiza tus compras en línea desde la comodidad de tu hogar, oficina o negocio en sams.com.mx y disfruta de todos los beneficios de tu membresía. </p>
                                <span class="reducedfrom">$66.00</span>
                                <span class="actual">$12.00</span><br>
                                <ul class="buttons">
                                    <li class="cart"><a href="#">Add To Cart</a></li>
