        ...
        <div class="main">
            <div class="shop_top">
                <div class="container">
                    ...
                    <p class="cart">No tiene artículos en su carrito de compras. Haga CLIC AQUÍ para continuar comprando<br>Click<a href="index.jsp"> here</a> to continue shopping</p>
                </div>
            </div>
        </div>
         <div class="footer">
