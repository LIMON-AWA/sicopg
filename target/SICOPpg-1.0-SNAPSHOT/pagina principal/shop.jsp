                            ...
                            <ul class="icon1 sub-icon1 profile_img">
                                <li><a class="active-icon c1" href="#"> </a>
                                    <ul class="sub-icon1 list">
                                        ...
                                        <div class="clear"></div>
                                        <li class="list_img"><img src="images/1.png" alt=""/></li>
                ...
                <div class="container">
                    <div class="row shop_box-top">
                        <div class="col-md-3 shop_box"><a href="single.jsp"/>
                                ...
                                <span class="new-box">
                                    <span class="new-label">NUEVAS</span>
                                </span>
                                <span class="sale-box">
                                    <span class="sale-label">VENTAS</span>
                                </span>
                                <div class="shop_desc">
                                    <h3><a href="#">Cerveza Corona</a></h3>
